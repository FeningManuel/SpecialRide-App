...
const data = [
  {
    ...
    title: "Trailer",
    multiplier: 1,
    Image: require('../assets/Trailer.png')
  },
  {
    id: "456",
    title: "Kia",
    multiplier: 1.2,
    Image: require('../assets/Kia.png')
  },
  {
    id: "789",
    title: "Motor King",
    multiplier: 1.5,
    Image: require('../assets/Motor King.png')
  },
];
  ...
  return (
    <TouchableWithoutFeedback onPress={dismissKeyboard}>
      <View style={styles.safeArea}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <Image
                  source={item.Image}
                  style={styles.carriersImage}
                  resizeMode="contain"
                />
                <Text style={styles.carriersTitle}>{item.title}</Text>
              </TouchableOpacity>
            )}
          />
        </View>
        ...
        <TouchableOpacity
          disabled={!selected}
          onPress={() => selected && navigation.navigate('ChooseCarrierScreen')}
          style={[
            styles.chooseButton,
