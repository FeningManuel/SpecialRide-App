  ...
  return (
    <TouchableWithoutFeedback onPress={dismissKeyboard}>
      <View style={styles.safeArea}>
        <Text style={styles.title}>Get a Bus</Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                ...
                style={[
                  styles.coachesOption,
                  selected?.id === item.id && styles.selectedCoachesOption
                ]}
              >
                <Image
                  source={item.Image}
                  style={styles.coachesImage}
                  resizeMode="contain"
                />
                <Text style={styles.coachesTitle}>{item.title}</Text>
              </TouchableOpacity>
            )}
          />
        </View>
